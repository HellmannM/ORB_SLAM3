...
int main(int argc, char **argv) {
    ...
    width_img = cap.get(CAP_PROP_FRAME_WIDTH); //get the width of frames of the video
    height_img = cap.get(CAP_PROP_FRAME_HEIGHT); //get the height of frames of the video
